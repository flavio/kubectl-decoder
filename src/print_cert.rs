// This file is taken from https://github.com/rusticata/x509-parser/blob/master/examples/print-cert.rs
...
pub(crate) fn print_x509_info(x509: &X509Certificate) -> io::Result<()> {
